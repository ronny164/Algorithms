...
public class BaseballEliminationTest {
    ...
    private Result print(String fileName) {
        ...
        for (String team : problem.teams()) {
            if (problem.isEliminated(team)) {
                System.out.println(team + ": " + problem.certificateOfElimination(team)
                        + ", eliminated: " + problem.isEliminated(team));
    ...
    public void testTeams4() {
        Result print = print("./src/test/resources/baseball/teams4.txt");
    ...
    public void testTeams4a() {
        Result print = print("./src/test/resources/baseball/teams4a.txt");
        assertEquals(2, print.count);
    ...
    public void testTeams4b() {
        Result print = print("./src/test/resources/baseball/teams4b.txt");
    ...
    public void testTeams5() {
        Result print = print("./src/test/resources/baseball/teams5.txt");
        assertEquals(1, print.count);
    ...
    public void testTeams7() {
        Result print = print("./src/test/resources/baseball/teams7.txt");
        assertEquals(2, print.count);
    ...
    public void testTeams32() {
        Result print = print("./src/test/resources/baseball/teams32.txt");
        assertEquals(9, print.count);
        assertEquals("[Team2, Team3, Team12, Team13, Team14, Team17, Team25, Team28, Team29]", print.teams.toString());
    }
    ...
    public void teamAllGames() {
        Result print = print("./src/test/resources/baseball/teams12-allgames.txt");
        assertEquals(1, print.count);
